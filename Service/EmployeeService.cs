...
employeeForCreation, bool trackChanges)
 ...
 trackChanges)
        {
            await CheckIfCompanyExistsAsync(companyId, trackChanges);
            var employeeDb = await GetEmployeeForCompanyAndCheckIfItExistsAsync(companyId, id,
            trackChanges);
...
bool compTrackChanges, bool empTrackChanges)
  ...
  (Guid companyId, Guid id, bool compTrackChanges, bool empTrackChanges)
        ...
        private async Task<Employee> GetEmployeeForCompanyAndCheckIfItExistsAsync
